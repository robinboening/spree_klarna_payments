...
- *Multiple* captures for one authorization are currently *not* supported because of Spree's process when capturing payments. This might change in future versions of Spree and this gem respectively. However, it is possible to use the MyKlarna portal to do that.
...
Supported versions are: Sree 2.3, 2.4, 3.0, 3.1, 3.2. Other versions might work but were not tested yet.
